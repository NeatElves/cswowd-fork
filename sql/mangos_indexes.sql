...
ALTER TABLE `creature_template` DROP INDEX `idx_spell1`;
ALTER TABLE `creature_template` DROP INDEX `idx_spell2`;
ALTER TABLE `creature_template` DROP INDEX `idx_spell3`;
ALTER TABLE `creature_template` DROP INDEX `idx_spell4`;
...
CREATE INDEX `idx_spell4`         ON `creature_template` (`spell4`);
