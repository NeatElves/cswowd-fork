...
function showPlayerGuild($guid, $char_data)
{
 ...
 if ($tabinfo)
 {
   ...
   echo '<br><div id=guildbank style="color: #FFFFFF; position: relative; width: 765; height: 424;">';
   echo '<img src="images/player_info/bank/guildbank.gif" style="position: absolute; left: 0; top: 0;">';
   echo '<div style="position: absolute; left: 0; top: 2; width: 725; text-align: center;"><b>Guild Bank</b></div>';
   $visible = "visible";
   foreach ($tabinfo as $tabid=>$tab)
   {
     ...
     if ($currentTabRights[$tabid]&GUILD_BANK_RIGHT_VIEW_TAB)
     {
       ...
       $visible = "hidden";
       if ($tabinfo)
         echo '<div style="position: absolute; left: 0; top: 28; width: 723;"><b>'.$tab['TabName'].'</b></div>';
       // Вывод вещей в табе
       ...
       // Описание таба
       $tip = $tab['TabName']?'onmouseover="Tip(\''.$tab['TabName'].'\');"':'';
       echo '<a href=# onclick="return showTab('.$tabid.');">';
       echo '<img src="images/player_info/bank/guildbanktab.gif" style="position: absolute; left: 724; top: '.(55 + $tabid*50).'; border: 0;">';
       echo '<img width=32px src="'.$img.'" '.$tip.' style="position: absolute; left: 727; top: '.(66 + $tabid*50).';border: 0;">';
       echo '</a>';
     }
     else
       echo '<img src="images/player_info/bank/guildbanktab.gif" onmouseover="Tip(\'no rights\');" style"position: absolute; left: 724; top: '.(55 + $tabid*50).'; border: 0;">';
   }
   echo '</div>';
 }
 else
