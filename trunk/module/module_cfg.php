...
//==================================================================
// Поиск вещей, спеллов, нпс, го, квестов, игроков
//==================================================================
...
$config['show_map_ptr']=0;                 // Ссылки в карту из местоположения
...
// Вывод 3D моделей
//==================================================================
$config['3d_model'] = 0;          		   // 3D модель персонажа (!!!настройте подключение к базе в файле /module/armory/show_characters.php!!!)
$config['3d_npc'] = 0; 					   // 3D модель НПС (требуется доступ к Интернет)
