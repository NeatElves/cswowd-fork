    ...
    for (var row = 0; row < tc_row; row++)
    {
      ...
      for (var col = 0; col < tc_col; col++)
      {
        ...
        if (d)
        {
            ...
            text+= '<img id="ico" src="'+m.dir+d.icon+'" width=44 height=44 style="position: absolute; left: 2; top: 2;">';
            text+= '<img id="brd" src="images/talentcalc/'+m.frame+'" style="position: absolute; left: 0; top: 0;">';
