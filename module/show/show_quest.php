...
if ($quest['RequiredSkill'])
 ...
 if ($quest['RequiredCondition'])
     echo '<tr><td>'.$lang['quest_cond'].'&nbsp;<font color=blue>'.getQuestRequiredCondition($quest['RequiredCondition']).'</font></td></tr>';
