...
var ttBgImg        = "tt.gif";           // path to background image;
var ttBorderColor  = "#3F3325";
var ttBorderWidth  = 5;
var ttDelay        = 100;          // time span until tooltip shows up [milliseconds]
var ttFontColor    = "#FFCC00";
var ttFontFace     = "arial,helvetica,sans-serif";
var ttFontSize     = "10px";
var ttFontWeight   = "normal";     // alternative is "bold";
var ttOffsetX      = 16;            // horizontal offset of left-top corner from mousepointer
...
var ttTitleColor   = "#FFCC00";    // color of caption text
var ttWidth        = 200;
...
function tt_Htm(tt, t_id, txt)
{
	...
	t_y += '<tr><td><table border="0" cellpadding="'+t_padd+'" cellspacing="'+t_bw+'px" width="100%">' +
